...
import logging 
import toolz
from pnas.pnasnet import PNASNet5Large
from pnas.pnasnet_decoder import PNASNet5LargeDecoder
...
class MultiBranch(torch.nn.Module):
    def __init__(self,
        ...
        self.decoders = torch.nn.ModuleDict({'branch1': PNASNet5LargeDecoder(decoder_scale=1024)})
    ...
    def forward(self, 
        ...
        # breakpoint()
        #return td
        return self.dec_custom(td_['features'])